...
const Home = () => {
  ...
  return (
    ...
    >
      <img className="hidden md:flex md:fixed top-1 md:object-cover xl:object-fill  overflow-visible w-screen h-screen" src={featured&&getImg(featured.backdrop_path)} alt="" />
