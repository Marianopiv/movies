...
const Movie = ({ title, poster, vote, date }) => {
  ...
  return !reveal ? (
    ...
    >
      <div className="absolute w-80 h-48 md:w-48  md:h-32 bg-gradient-to-b from-transparent to-gray-900 rounded-md"></div>{" "}
      <img
        className="absolute bottom-20 md:bottom-14 z-50 border-white border rounded-full "
        src={groupPlay}
        alt=""
      />{" "}
      <p className="absolute text-white bottom-10 text-sm custom-text custom-movie md:bottom-8">
        {title}
      </p>
      <img
    ...
    >
      ...
      <div className="absolute w-80 h-48 md:w-48  md:h-32 bg-gradient-to-b from-gray-900 to-gray-900 opacity-60 rounded-md"></div>{" "}
      <img
        className="absolute bottom-16 mb-2 left-8 md:bottom-10 z-50 border-white border rounded-full w-8 md:w-6 md:left-20 md:top-2 md:ml-1 "
        src={playLittle}
        alt=""
      />{" "}
