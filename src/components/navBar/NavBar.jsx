...
const NavBar = () => {
  ...
  return (
    <div className="flex relative justify-center items-center w-auto md:w-screen gap-16 md:gap-0 md:justify-around pt-5 md:pl-4">
      {!toogleMovie && (
      ...
      <div
        className={`text-white rounded-full border flex justify-center md:w-fit items-center md:border-0  w-9 h-9 pb-2 z-50 ${
      ...
      <p className="z-20 navTitle md:-order-last">liteflix</p>
